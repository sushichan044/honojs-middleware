...
export const NON_RESPECTING_BOTS = ["AddSearchBot", "AgentTimes", "AI2Bot-DeepResearchEval", "amazon-QBusiness", "AmazonBuyForMe", "Amzn-SearchBot", "Amzn-User", "Andibot", "anthropic-ai", "ApifyBot", "ApifyWebsiteContentCrawler", "Aranet-SearchBot", "Awario", "AzureAI-SearchBot", "bigsur.ai", "Brightbot", "Brightbot 1.0", "BuddyBot", "Bytespider", "Channel3Bot", "ChatGLM-Spider", "Claude-Code", "Claude-Web", "CloudVertexBot", "Code", "cohere-ai", "cohere-training-data-crawler", "CragCrawler", "Crawl4AI", "Cursor", "Datenbank Crawler", "DeepSeekBot", "Diffbot", "DoubaoBot", "Echobot Bot", "EchoboxBot", "ERNIEBot", "ExaBot", "ExaSearchBot", "facebookexternalhit", "Factset_spyderbot", "GeistHaus-PageFetcher", "Gemini-Deep-Research", "Google-Firebase", "Google-Gemini-CLI", "Google-NotebookLM", "GoogleAgent-Mariner", "GoogleAgent-URLContext", "HenkBot", "iAskBot", "iaskspider", "iaskspider/2.0", "imageSpider", "img2dataset", "ISSCyberRiskCrawler", "kagi-fetcher", "Kangaroo Bot", "Kimi-User", "KunatoCrawler", "laion-huggingface-processor", "LAIONDownloader", "LCC", "Lightpanda", "LinerBot", "Linguee Bot", "LinkupBot", "Manus-User", "meta-externalfetcher", "Meta-ExternalFetcher", "meta-webindexer", "MistralAI-User", "MyCentralAIScraperBot", "NagetBot", "netEstate Imprint Crawler", "newsai", "NotebookLM", "NovaAct", "OAI-AdsBot", "opencode", "Operator", "PanguBot", "Perplexity-User", "PhindBot", "Poggio-Citations", "Poseidon Research Crawler", "QualifiedBot", "Querit-SearchBot", "QueritBot", "QuillBot", "quillbot.com", "QwenBot", "Reflectionbot", "Scrapy", "Shap-User", "Sidetrade indexer bot", "Spider", "TavilyBot", "Terra Cotta", "Thinkbot", "TikTokSpider", "Timpibot", "TongyiBot", "Trae", "TwinAgent", "UseAI", "WARDBot", "Webzio-Extended", "webzio-extended", "wpbot", "WRTNBot", "YaK", "YiyanBot", "ZanistaBot"];
...
export const NON_RESPECTING_BOTS_REGEX = /(ADDSEARCHBOT|AGENTTIMES|AI2BOT-DEEPRESEARCHEVAL|AMAZON-QBUSINESS|AMAZONBUYFORME|AMZN-SEARCHBOT|AMZN-USER|ANDIBOT|ANTHROPIC-AI|APIFYBOT|APIFYWEBSITECONTENTCRAWLER|ARANET-SEARCHBOT|AWARIO|AZUREAI-SEARCHBOT|BIGSUR.AI|BRIGHTBOT|BRIGHTBOT 1.0|BUDDYBOT|BYTESPIDER|CHANNEL3BOT|CHATGLM-SPIDER|CLAUDE-CODE|CLAUDE-WEB|CLOUDVERTEXBOT|CODE|COHERE-AI|COHERE-TRAINING-DATA-CRAWLER|CRAGCRAWLER|CRAWL4AI|CURSOR|DATENBANK CRAWLER|DEEPSEEKBOT|DIFFBOT|DOUBAOBOT|ECHOBOT BOT|ECHOBOXBOT|ERNIEBOT|EXABOT|EXASEARCHBOT|FACEBOOKEXTERNALHIT|FACTSET_SPYDERBOT|GEISTHAUS-PAGEFETCHER|GEMINI-DEEP-RESEARCH|GOOGLE-FIREBASE|GOOGLE-GEMINI-CLI|GOOGLE-NOTEBOOKLM|GOOGLEAGENT-MARINER|GOOGLEAGENT-URLCONTEXT|HENKBOT|IASKBOT|IASKSPIDER|IASKSPIDER\/2.0|IMAGESPIDER|IMG2DATASET|ISSCYBERRISKCRAWLER|KAGI-FETCHER|KANGAROO BOT|KIMI-USER|KUNATOCRAWLER|LAION-HUGGINGFACE-PROCESSOR|LAIONDOWNLOADER|LCC|LIGHTPANDA|LINERBOT|LINGUEE BOT|LINKUPBOT|MANUS-USER|META-EXTERNALFETCHER|META-EXTERNALFETCHER|META-WEBINDEXER|MISTRALAI-USER|MYCENTRALAISCRAPERBOT|NAGETBOT|NETESTATE IMPRINT CRAWLER|NEWSAI|NOTEBOOKLM|NOVAACT|OAI-ADSBOT|OPENCODE|OPERATOR|PANGUBOT|PERPLEXITY-USER|PHINDBOT|POGGIO-CITATIONS|POSEIDON RESEARCH CRAWLER|QUALIFIEDBOT|QUERIT-SEARCHBOT|QUERITBOT|QUILLBOT|QUILLBOT.COM|QWENBOT|REFLECTIONBOT|SCRAPY|SHAP-USER|SIDETRADE INDEXER BOT|SPIDER|TAVILYBOT|TERRA COTTA|THINKBOT|TIKTOKSPIDER|TIMPIBOT|TONGYIBOT|TRAE|TWINAGENT|USEAI|WARDBOT|WEBZIO-EXTENDED|WEBZIO-EXTENDED|WPBOT|WRTNBOT|YAK|YIYANBOT|ZANISTABOT)/;
